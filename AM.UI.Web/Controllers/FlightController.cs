...
namespace AM.UI.Web.Controllers
{
    public class FlightController : Controller
    {
        ...
        {
            var flights = flightDate == null
                ? flightService.GetAll()
                : flightService.GetFlightsGreaterThan(flightDate.Value);

            ViewBag.FlightDate = flightDate?.ToString("yyyy-MM-dd"); // pour préremplir le champ dans la vue
            return View(flights);
        }
